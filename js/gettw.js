	...
	$(go.Palette, "divPalette",
		{
			...
			model: new go.GraphLinksModel([  // contenidos de la paleta
					// nodos
					// nodos
					{ text: "Actor", figure: "Actor", font: "16pt Roboto, sans-serif, Arial, Helvetica", width: nodeSize, height: nodeSize, editable: true, category: "shape" },
					{ text: "Use case", figure: "Ellipse", font: "16pt Roboto, sans-serif, Arial, Helvetica", width: nodeSize, height: nodeSize/2, editable: true, fill: "lightskyblue", category: "shape" },
					{ text: "System", figure: "Rectangle", fill: "lightgray", font: "16pt Roboto, sans-serif, Arial, Helvetica", alignment: go.Spot.TopLeft, width: nodeSize, height: nodeSize, editable: true, category: "shape" },
					{ text: "Package", figure: "Package", fill: "lightskyblue", font: "16pt Roboto, sans-serif, Arial, Helvetica", alignment: go.Spot.TopLeft, width: nodeSize, height: nodeSize, editable: true, category: "shape" },
				], [ 
					// enlaces
					...
					{ points: new go.List().addAll([new go.Point(0, 0), new go.Point(50, 0)]), linkStrokeColor: "black", linkStrokeWidth: "2", 
						fromArrowShape: "", fromArrowColor: "black", fromArrowStrokeColor: "black", fromArrowStrokeWidth: "2", 
						toArrowShape: "Triangle", toArrowColor: "white", toArrowStrokeWidth: "2", category: "link" },
					{ points: new go.List().addAll([new go.Point(0, 0), new go.Point(50, 0)]), linkStrokeColor: "black", linkStrokeWidth: "2", 
						fromArrowShape: "", fromArrowColor: "black", fromArrowStrokeColor: "black", fromArrowStrokeWidth: "2", 
						toArrowShape: "OpenTriangle", toArrowColor: "black", toArrowStrokeWidth: "2", dash: "Dash Line", text: "extends", editable: false, category: "link" }, 
					{ points: new go.List().addAll([new go.Point(0, 0), new go.Point(50, 0)]), linkStrokeColor: "black", linkStrokeWidth: "2", 
						fromArrowShape: "", fromArrowColor: "black", fromArrowStrokeColor: "black", fromArrowStrokeWidth: "2", 
						toArrowShape: "OpenTriangle", toArrowColor: "black", toArrowStrokeWidth: "2", dash: "Dash Line", text: "includes", editable: false, category: "link" }, 
				]
			)
		}
	);
